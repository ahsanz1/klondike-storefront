...
export const oamdata = {
  heading: 'OEM Approvals',
  oam: [
    {
      image: {
        url: '/static/images/audi.png',
        altText: 'alt',
      },
    ...
    {
      image: {
        url: '/static/images/Cummins.png',
        altText: 'alt',
      },
      heading: 'Cummins Approved',
      description:
        'Cummins, the world’s largest manufacturer of diesel engines and related technology, has officially approved KLONDIKE 10W-30 CK-4 and KLONDIKE 15W-40 CK-4 against current specification CES20086.',
      lebal: '/static/images/vec.png',
    },
    {
      image: {
        url: '/static/images/DD3.png',
        altText: 'alt',
      },
      heading: 'Detroit Diesel Approved',
      description:
    ...
    {
      image: {
        url: '/static/images/Mercedes-Benz_productpage_rev.png',
        altText: 'alt',
      },
    ...
    {
      image: {
        url: '/static/images/NMMALogo_approvalspage_.png',
        altText: 'alt',
      },
      heading: 'NMMA Approved',
      description:
    ...
    {
      image: {
        url: '/static/images/RenaultLogo_approvalspage.png',
        altText: 'alt',
      },

      heading: 'Renault Approved',
      description:
        'Renault Trucks offers commercial and military vehicle users a large choice of innovative vehicles adapted to a wide range of transport activities. Renault Trucks is active in over 100 countries, with its vehicles design and assembly, as well as the production of most components, carried out in France.',
      lebal: '/static/images/vec.png',
    },
    {
      image: {
        url: '/static/images/Volkswagen_productpage_rev.png',
        altText: 'alt',
      },
      heading: 'Volkswagen Approved',
      description:
        'Volkswagen is the largest automaker by worldwide sales in 2016 and 2017. Descended from sound German engineering principles and a passion for design that favours performance, the VW name has become affiliated with iconic vehicles.',
      lebal: '/static/images/vec.png',
    },
    {
      image: {
        url: '/static/images/Volvo_approvalspage 1.png',
        altText: 'alt',
      },
      heading: 'Volvo Approved',
      description:
        'Volvo is one of the world’s leading manufacturers of trucks, buses, construction equipment and marine and industrial engines. To ensure only high quality and rigorously tested oils and lubricants are used in their engines, Volvo has developed a technologically advanced engine oil certification program.',
      lebal: '/static/images/vec.png',
    },
  ],
}

export const bigVideodata = [
  {
    title: 'nano',

    src: 'https://player.vimeo.com/video/446947299',

    details: 'KLONDIKE nano – Engineered with breakthrough nanotechnology',
  },

  {
    title: 'unmatched distribution',

    src: 'https://player.vimeo.com/video/339222693',
...

  {
    ...
    src: 'https://player.vimeo.com/video/102849510?title=0&byline=0&portrait=0',

    details: 'KLONDIKE nano – Engineered with breakthrough nanotechnology',
  },
]

export const smallVideodata = [
  {
    title: 'DEMO',

    src:
      'https://player.vimeo.com/video/188227055? title=0&byline=0&portrait=0',

    details:
      'KLONDIKE at DEMO® International 2016, Canada’s Largest Forestry Equipment Show',
  },

  {
    ...
    src:
      'https://player.vimeo.com/video/592403349?badge=0&autopause=0&player_id=0&app_id=58479&h=d71933da8b',

    details: 'KLONDIKE’s Concentrate and 50/50 Ready to Use Antifreeze',
  },

  {
    ...
    src:
      'https://player.vimeo.com/video/557677770?badge=0&autopause=0&player_id=0&app_id=58479&h=f88f4c0987',

    details: 'DOT 5.1 Universal Synthetic Brake Fluid',
  },

  {
    title: 'SyntheticDualClutch',

    src:
      'https://player.vimeo.com/video/528434703?badge=0&autopause=0&player_id=0&app_id=58479',

    details: 'KLONDIKE Full Synthetic Dual Clutch Transmission Fluid',
  },
]
...
export const cataogData = {
  ...
  english:
    'https://klondikelubricants.com/wp-content/uploads/2021/07/2021.06.01_KLONDIKE-Catalogue-Spring_Summer-2021-Edition_English_website.pdf',
  franch:
    'https://klondikelubricants.com/wp-content/uploads/2021/07/2021.06.01_KLONDIKE-Catalogue-Spring_Summer-2021-Edition_English_website.pdf',
}
...
export const pdpdatasheet = {
  ...
  paragraph: [
    ...
    {
      text:
        'KLONDIKE Full Synthetic CVT Fluid is formulated with premium full synthetic base oil and technologically advanced additive. KLONDIKE Full Synthetic CVT Fluid is a premium performance, fully synthetic formulation designed for modern Continuously Variable Transmission designs in passenger cars. This specially formulated combination of 100% synthetic base oils and state-of-the-art additive technology ensures peak performance and outstanding fuel economy across a broad range of applications using belt or chain driven technology.',
    },
  ],
  Readmore: 'Read more',
}
